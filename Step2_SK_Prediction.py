...
#         gesturesList=smp.getGestures()
        ...
        dbn = GRBM_DBN(numpy_rng=numpy_rng, n_ins=528, hidden_layers_sizes=[2000, 1000], n_outs=class_count*10+1, finetune_lr=0.1)
        dbn.load('dbn_model3less_nonvar2017-05-11-10-19-20.npy')
