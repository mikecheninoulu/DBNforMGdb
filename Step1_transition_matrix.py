...
used_joints = ['ElbowLeft', 'WristLeft', 'ElbowRight', 'WristRight']#we can aadd more here
...
Prior = numpy.zeros(shape=(class_count*STATE_NO + 1))
Transition_matrix = numpy.zeros(shape=(class_count*STATE_NO + 1,class_count*STATE_NO + 1))
